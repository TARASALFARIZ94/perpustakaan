                        ...
                        @foreach ($member as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" wire:click="confirm({{ $data->id }})" data-bs-toggle="modal"
                                        data-bs-target="#deletepage" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea wire:model="address" class="form-control" cols="30" rows="10">{{ @old('address') }}"></textarea>
                                @error('address')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" wire:click="resetInput" class="btn btn-primary"
